...
/// <summary>
///     Provides the base class for your application to implement a WebSocket connection. Derive from this class and then pass
///     an instance of your derived class to <see cref="HttpResponse.WebSocket"/>.</summary>
public abstract class WebSocket : MarshalByRefObject
{
    ...
    ///     <list type="bullet">
    ///         <item><description>
    ///             This method is called only once per instance, and it is called when the socket has switched from the HTTP
    ///             handshake to the WebSocket protocol.</description></item>
    ///         <item><description>
