...
/// <summary>
///     Encapsulates all supported HTTP response headers. A request handler can set these appropriately to cause the server to
///     emit the required headers. See Remarks for a list of headers which are set by default.</summary>
/// <remarks>
