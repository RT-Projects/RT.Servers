...
public class SimpleSession(string cookieName = "SessionID")
{
    ...
    public string CookieName { get; private set; } = cookieName;

    /// <summary>The path of the retrieved session cookie.</summary>
    public string CookiePath { get; private set; }

    /// <summary>
    ///     The expiry date of the retrieved session cookie. If null, the session expires when the client's browser closes.</summary>
