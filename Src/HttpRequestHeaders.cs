...
#pragma warning restore 1591    // Missing XML comment for publicly visible type or member
    ...
    private Dictionary<string, string> _headers = new(StringComparer.InvariantCultureIgnoreCase);
    ...
    internal bool ParseAndAddHeader(string name, string value)
    {
        ...
        try
        {
            ...
            else if (nameLower == "content-length" && ContentLength == null && int.TryParse(value, out var intOutput))
            {
    ...
    private static void parseAndAddCookies(ref Dictionary<string, Cookie> cookies, string cookieHeaderValue)
    {
        ...
        while (cookieHeaderValue.Length > 0)
        {
            ...
            {
                if (DateTime.TryParse(cookieHeaderValue, out var output))
    ...
    {
        get => _headers.TryGetValue(key, out var result) ? result : null;
