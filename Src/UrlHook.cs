...
/// <summary>
///     Encapsulates properties of a URL that can be mapped to a request handler using <see cref="UrlMapping"/>. This class is
///     immutable.</summary>
[ClassifyIgnoreIfDefault]
public sealed class UrlHook : IEquatable<UrlHook>, IComparable<UrlHook>, IClassifyObjectProcessor
{
    /// <summary>
    ///     Gets a value indicating what domain name the hook applies to. Returns <c>null</c> if it applies to all domains.</summary>
    ...
    /// <summary>
    ///     Gets a value indicating whether the hook applies to all subdomains of the domain specified by <see cref="Domain"/>
    ///     (<c>false</c>) or the specific domain only (<c>true</c>).</summary>
    ...
    /// <param name="path">
    ///     If <c>null</c>, the hook applies to all URL paths. Otherwise, the hook applies to this path and all subpaths or to
    ///     this path only, depending on the value of <paramref name="specificPath"/>.</param>
    ...
    ///     If <c>false</c>, the hook applies to all subpaths of the path specified by <paramref name="path"/>. Otherwise it
    ///     applies to the specific path only.</param>
    ...
    /// <summary>Compares mappings for equality.</summary>
    public override bool Equals(object obj) => obj is UrlHook other && Equals(other);
